...
Das Programm sollte ... \\
\\... in der Programmiersprache Python geschrieben sein.
\\... mit einer Schnittstelle (GUI oder CLI) ausgestattet sein.
\\... Inhalte verarbeiten und ausgeben können.
\\... sich erfolgreich implementieren und kompilieren lassen.
\\... plattformübergreifend laufend sein (Windows und Linux).
\\... ohne kostenpflichtige Software oder Bibliothekne auskommen.
\\... Quellcode mit beschreibenden Kommentaren enthalten.
\\... gegebenenfalls Dateien enthalten, die zu Testzwecken genutzt werden können.\\
